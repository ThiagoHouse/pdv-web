...
if(isset($error))
{
	echo "<div class='card-body error_message'>".$error."</div>";
}

if (isset($warning))
{
	echo "<div class='card-body warning_mesage'>".$warning."</div>";
}

if (isset($success))
{
	echo "<div class='card-body success_message'>".$success."</div>";
}
?>

<!-- MODO DA OPERAÇÃO -->
<div class="card mr-2" id="register_wrapper">
	<?php echo form_open("sales/change_mode",array('id'=>'mode_form')); ?>
		<span class="pl-1"><?php echo $this->lang->line('sales_mode') ?></span>
	...
	<div id="show_suspended_sales_button">
		<?php echo anchor("sales/suspended/width:425",
			...
			"<div class='btn btn-sm btn-secondary'><span style='font-size:73%;'>".$this->lang->line('sales_suspended_sales')."</span></div>",
	...
	<!-- input de produtos /serviços -->
	<?php echo form_input(array('class'=>'input-group input-group-sm mb-3 input-group-text bg-white text-dark col-9',
								'name'=>'item',
								'id'=>'item',
								'size'=>'20')); 
	?>
	<div id="new_item_button_register" >
			...
			"<div class='btn btn-sm btn-primary'><span>".$this->lang->line('sales_new_item')."</span></div>",
			array('class'=>'thickbox none','title'=>$this->lang->line('sales_new_item')));
			?>
		</div>

</form>
<table class="table table-striped" id="register">
<thead>
<tr>
...
<div class="card" id="overall_sale">
	<div class="card p-2 text-center bg-light">
		...
		<?php echo form_input(array('name'=>'customer',
									'class'=>'input-group input-group-sm mb-3 input-group-text bg-white text-primary',
									'id'=>'customer',
									// 'size'=>'30',
